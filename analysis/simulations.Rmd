...
group_barchart = function(dirname, prefix='all_res_', n_x_show = 8, thresh = 0.05, pip_thresh = 0.5, methods=c()) {
  ...
  for(m in methods) {
    ...
    num_cols = dim(res)[2]
    if(m == 'susie' || m == 'susie_svd' || m == 'susie_cate' || m == 'susie_rpca' || m == 'zuber') {
      num_betas = num_cols 
    } else {
...
* The density parameters were decreased from $\phi_X=\phi_Y=\phi_Z=50\%$ to $\phi_X=5\%, \phi_Y=\phi_Z=5\%$; thus a much smaller percentage of variants will affect the phenotypes, especially for pleiotropic effects. 
* The defaults for $\theta_{GX}$, $\psi_X$, and $\theta_{GY}$ were increased from $0.1$ to $0.2$.
  ...
  The resulting heritabilities are $h^2(X)=40\%$, $h^2(Z)=40\%$, $h^2(Y)=49.25\%$.
...
```{r both_plei_highsnp, echo=FALSE, fig.width=12}
group_barchart('data/results_highsnp_fixed/both_plei_gx_0.2_gy_0.2_gz_0.4_psix_0.2_psiy_0.15_mu_0/',
               prefix='all_res_', n_x_show = 8, thresh = 0.05,
               methods=c('2sls', '2sls_oracle', '2sls_cate', 'susiecate', 'ivw', 'robust', 'grapple'))
```
...
```{r no_plei_highsnp, echo=FALSE, fig.width=12}
group_barchart('data/results_highsnp_fixed/no_plei_gx_0.2_gy_0.2_gz_0.4_psix_0.2_psiy_0.15_mu_0/',
               prefix='all_res_', n_x_show = 8, thresh = 0.05,
               methods=c('2sls', '2sls_oracle', '2sls_cate', 'susiecate', 'ivw', 'robust', 'grapple'))
```
...
Here are the results with only correlated pleiotropy:

```{r cor_plei_highsnp, echo=FALSE, fig.width=12}
group_barchart('data/results_highsnp_fixed/cor_plei_gx_0.2_gy_0.2_gz_0.4_psix_0.2_psiy_0.15_mu_0/',
               prefix='all_res_', n_x_show = 8, thresh = 0.05,
               methods=c('2sls', '2sls_oracle', '2sls_cate', 'susiecate', 'ivw', 'robust', 'grapple'))
```
...
Finally, here are the results with only uncorrelated pleiotropy:

```{r uncor_plei_highsnp, echo=FALSE, fig.width=12}
group_barchart('data/results_highsnp_fixed/uncor_plei_gx_0.2_gy_0.2_gz_0.4_psix_0.2_psiy_0.15_mu_0/',
               prefix='all_res_', n_x_show = 8, thresh = 0.05,
               methods=c('2sls', '2sls_oracle', '2sls_cate', 'susiecate', 'ivw', 'robust', 'grapple'))
```
...
### Simulations with Cate and RPCA plugins
...
```{r cor_plei_rpcacate1, echo=FALSE, fig.width=12}
group_barchart('data/results_rpca_cate1/cor_plei_gx_0.2_gy_0.2_gz_0.4_psix_0.1_psiy_0.15_mu_0.0/',
               prefix='all_res_', n_x_show = 8, thresh = 0.05,
               methods=c('ivw', 'ivw_cate', 'ivw_rpca', 
                         'robust', 'robust_cate', 'robust_rpca', 'susie', 'susie_cate', 'susie_rpca'))
               #methods=c('2sls_oracle', '2sls_cate', '2sls_rpca', 'ivw', 'ivw_cate', 'ivw_rpca', 
                #         'robust', 'robust_cate', 'robust_rpca', 'susie', 'susie_cate', 'susie_rpca'))
```
...
```{r cor_plei_rpcacate2, echo=FALSE, fig.width=12}
group_barchart('data/results_rpca_cate2/cor_plei_gx_0.2_gy_0.2_gz_0.4_psix_0.1_psiy_0.15_mu_0.0/',
               prefix='all_res_', n_x_show = 8, thresh = 0.05,
               methods=c('ivw', 'ivw_cate', 'ivw_rpca', 
                         'robust', 'robust_cate', 'robust_rpca', 'susie', 'susie_cate', 'susie_rpca'))
               #methods=c('2sls_oracle', '2sls_cate', '2sls_rpca', 'ivw', 'ivw_cate', 'ivw_rpca', 
...
```{r cor_plei_rpcacate4, echo=FALSE, fig.width=12}
group_barchart('data/results_rpca_cate4/cor_plei_gx_0.2_gy_0.2_gz_0.4_psix_0.1_psiy_0.15_mu_0.0/',
               prefix='all_res_', n_x_show = 8, thresh = 0.05,
               methods=c('ivw', 'ivw_cate', 'ivw_rpca', 
                         'robust', 'robust_cate', 'robust_rpca', 'susie', 'susie_cate', 'susie_rpca'))
               #methods=c('2sls_oracle', '2sls_cate', '2sls_rpca', 'ivw', 'ivw_cate', 'ivw_rpca', 
...
```{r both_plei_rpcacate4, echo=FALSE, fig.width=12}
group_barchart('data/results_rpca_cate4/both_plei_gx_0.2_gy_0.2_gz_0.4_psix_0.1_psiy_0.15_mu_0.0/',
               prefix='all_res_', n_x_show = 8, thresh = 0.05,
               methods=c('ivw', 'ivw_cate', 'ivw_rpca', 
                         'robust', 'robust_cate', 'robust_rpca', 'susie', 'susie_cate', 'susie_rpca'))
               #methods=c('2sls_oracle', '2sls_cate', '2sls_rpca', 'ivw', 'ivw_cate', 'ivw_rpca', 
...
```{r powfpr_both_plei_rpcacate4, echo=FALSE, fig.width=12}
power_fpr_thresh_plot('data/results_rpca_cate4/both_plei_gx_0.2_gy_0.2_gz_0.4_psix_0.1_psiy_0.15_mu_0.0/', 
